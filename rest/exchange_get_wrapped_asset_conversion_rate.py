...
if len(sys.argv) != 2:
    exit('Usage: python exchange_get_wrapped_asset_conversion_rate.py <wrapped_asset_id>')

wrapped_asset_id = sys.argv[1]

url = f'https://api.exchange.coinbase.com/wrapped-assets/{wrapped_asset_id}/conversion-rate'

...
if len(sys.argv) != 3:
    exit('Usage: python exchange_get_fee_estimate_for_withdrawal.py <address> <currency>')

address = sys.argv[1]
currency = sys.argv[2]

url = f'https://api.exchange.coinbase.com/withdrawals/fee-estimate?crypto_address={address}&currency={currency}'

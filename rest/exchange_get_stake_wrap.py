...
if len(sys.argv) != 2:
    exit('Usage: python exchange_get_stake_wrap.py <stake_wrap_id>')

stake_wrap_id = sys.argv[1]

url = f'https://api.exchange.coinbase.com/wrapped-assets/stake-wrap/{stake_wrap_id}'
